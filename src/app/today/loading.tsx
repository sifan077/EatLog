    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-emerald-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 pt-4 transition-colors duration-300">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-6">
          <div className="h-8 sm:h-10 bg-gray-200 dark:bg-gray-700 rounded w-48 sm:w-64 animate-pulse" />
          <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded w-32 mt-1 animate-pulse" />
        </div>

        {/* Main Content Skeleton */}
        <main className="max-w-4xl mx-auto px-4 pb-8 sm:px-6 sm:pb-12">
          {/* Quick Record Form Skeleton */}
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 sm:p-8 border border-white/50 dark:border-gray-800/50 mb-8 sm:mb-10 transition-colors duration-300">
