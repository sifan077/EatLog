    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-emerald-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 pt-4 transition-colors duration-300">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 mb-6">
          ...
          <div className="h-8 sm:h-10 bg-gray-200 dark:bg-gray-700 rounded w-24 mt-4 animate-pulse" />
        </div>
        ...
        <main className="max-w-4xl mx-auto px-4 pb-8 sm:px-6 sm:pb-12">
          ...
          <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 sm:p-8 border border-white/50 dark:border-gray-800/50 transition-colors duration-300">
            <div className="h-7 bg-gray-200 dark:bg-gray-700 rounded w-32 mb-6 animate-pulse" />

            {/* Photo Skeleton */}
            <div className="mb-6">
              <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded w-12 mb-3 animate-pulse" />
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                {Array(3)
                  .fill(0)
                  .map((_, i) => (
                    <div key={i} className="h-28 sm:h-32 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
                  ))}
              </div>
              <div className="h-32 bg-gray-200 dark:bg-gray-700 rounded-xl mt-4 animate-pulse" />
            </div>

            {/* Content Skeleton */}
            <div className="mb-6">
              <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded w-12 mb-2 animate-pulse" />
            ...
            <div className="flex gap-3">
              ...
              <div className="w-24 h-12 bg-gray-200 dark:bg-gray-700 rounded-xl animate-pulse" />
            </div>
          </div>
        </main>
      </div>
