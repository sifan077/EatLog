    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-xl p-4 sm:p-6 border border-white/50 dark:border-gray-800/50 transition-colors duration-300">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="h-7 bg-gray-200 dark:bg-gray-700 rounded w-32 sm:w-48 animate-pulse" />
          <div className="w-8 h-8 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
        </div>
      ...
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-xl p-4 sm:p-6 border border-white/50 dark:border-gray-800/50 transition-colors duration-300">
        ...
        <div className="space-y-4 sm:space-y-6">
          {[1, 2].map((i) => (
            <div
              key={i}
              className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden border border-white/50 dark:border-gray-800/50 transition-colors duration-300"
            >
              <div className="flex flex-col sm:flex-row">
                <div className="w-full h-48 sm:w-48 sm:h-48 flex-shrink-0 bg-gray-200 dark:bg-gray-700 animate-pulse" />
